 ...
 */
class users_order_by extends \Spawnia\Sailor\ObjectLike
{
    /**
    ...
    protected function converters(): array
    {
        ...
        return $converters ??= [
            'created_at' => new \Spawnia\Sailor\Convert\NullConverter(new \Spawnia\Sailor\Convert\EnumConverter),
            'email' => new \Spawnia\Sailor\Convert\NullConverter(new \Spawnia\Sailor\Convert\EnumConverter),
            'email_verified_at' => new \Spawnia\Sailor\Convert\NullConverter(new \Spawnia\Sailor\Convert\EnumConverter),
